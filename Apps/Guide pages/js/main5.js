(function() {
    ...
    window.CanvasSlideshow = function( options ) {
      ...
      //  TEXTS
      /// ---------------------------   
      //var fontcolor=["#f0ff00","#00ff00","#10afee"]; 
      var style = [];
      for ( var i = 0; i < options.sprites.length; i++ ){
      style.push(new PIXI.TextStyle({
        fill: (options.textColor)[i],//options.textColor,
        wordWrap: false,
        //wordWrapWidth: 400,
         letterSpacing: 20,
        fontSize: 60,
      ...
      this.loadPixiSprites = function( sprites ) {
        ...
        for ( var i = 0; i < rSprites.length; i++ ) {
          ...
          if ( rTexts ) {
            var richText = new PIXI.Text( rTexts[i], style[i]);
